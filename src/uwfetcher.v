...
//=============================================================================
// Here we fetch incoming data from M_AXI and write it to the FIFO.  It's safe
// to blindly write to the FIFO because we never request data from host RAM
// unless we know there is room for it in the FIFO.
//=============================================================================
always @(posedge clk) begin
